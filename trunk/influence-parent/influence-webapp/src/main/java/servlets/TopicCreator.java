...
public class TopicCreator extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int outOfTopicFileIndex = 0; outOfTopicFileIndex < topicFilesCount;
             outOfTopicFileIndex++) {
    ...
    private void createTopicFile(String filePath, List<String> inTopicFiles,
                                 List<String> outOfTopicFiles) throws IOException {
