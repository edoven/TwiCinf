package it.cybion.influence.ranking.utils.text_extractor;
...
public class TweetsTextExtractor
{
	...
	public static List<String> getUrlsExpandedText(List<String> tweetsJsons)
	{
		...
		{
			for (it.cybion.influence.ranking.utils.text_extractor.TweetsTextExtractor.Tweet.Url url : tweet.entities.urls)
