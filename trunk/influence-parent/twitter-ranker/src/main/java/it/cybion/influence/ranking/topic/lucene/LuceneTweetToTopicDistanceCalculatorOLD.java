...
public class LuceneTweetToTopicDistanceCalculatorOLD implements TweetToTopicDistanceCalculator
{
	private static final Logger logger = Logger.getLogger(LuceneTweetToTopicDistanceCalculatorOLD.class);
	...
	public LuceneTweetToTopicDistanceCalculatorOLD(List<Directory> indexes)
	{	
