...
public class InAndOutDegreeFilterManagerTEST {
	...
	public static void main(String args[]) throws IOException, TwitterException {	
		...
		/*
		*	This is the result of first iteration (inDegree=10% + outDegree=5% + descriptionDictionaryFilter)
		*/
		...
		InAndOutDegreeFilterManager filterManager = new InAndOutDegreeFilterManager(0.1, 0.05);
