...
public interface GraphFacade
{
	 ...
	 */
	Map<Long, Integer> getInDegrees(List<Long> usersToBeCalculated, List<Long> sourceUsers) throws UserVertexNotPresent;
	 ...
	 * destinationUsers
	 */
	Map<Long, Integer> getOutDegrees(List<Long> usersToBeCalculated, List<Long> destinationUsers) throws UserVertexNotPresent;
