...
public class UserMetricsCalculator {
	...
	public UserMetricsCalculator(TwitterFacade twitterFacade,
								 TweetToTopicSimilarityCalculator topicSimilarityCalculator) {
	...
	public UserMetricsReport caluclateReport(Long userId) {
		...
		float topicSimilarityTweetByTweet = getTopicSimilarityTweetByTweet(tweets);
