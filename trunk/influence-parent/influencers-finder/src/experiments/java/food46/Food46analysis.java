...
import it.cybion.influencers.filtering.expansion.FollowersAndFriendsExpansionFilterManager;
...
public class Food46analysis {
	...
	private static List<FilterManager> getFilterManagers() {
		...
		FollowersAndFriendsExpansionFilterManager followersAndFriendsExpansionFilter
			= new FollowersAndFriendsExpansionFilterManager();
		filters.add(0, followersAndFriendsExpansionFilter);
		return filters;
	}
}
