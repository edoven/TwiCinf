...
public class DescriptionAndStatusDictionaryFilterManager implements FilterManager
{
	...
	/*
	 * This method creates and sets user2description by asking the description
	 * to twitterFacade. It acts in different ways depending on
	 * expansionDirection.
	 */
	private void solveDependencies()
	{
		createUsers2descriptions(); // this gets the descriptions from
									// twitterFacade
	}
	...
	public String toString()
	{
		...
		String result = "DescriptionDictionaryFilter" + " (inputSize=" + inputSize + " dictionary=[";
