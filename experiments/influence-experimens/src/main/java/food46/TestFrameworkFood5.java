...
public class TestFrameworkFood5 {
	...
	private static List<Long> get5UsersIds() {
...
//		usersIds.add(81079701L); //elisiamenduni
	...
	private static List<FilterManager> getFilterManagers() {
		...
		InAndOutDegreeFilterManager inAndOutDegree1 = new InAndOutDegreeFilterManager(0.05, 0.1);
		InAndOutDegreeFilterManager inAndOutDegree2 = new InAndOutDegreeFilterManager(0.1, 0.025);
